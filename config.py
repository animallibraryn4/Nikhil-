...
# NAMA OWNER
OWNER = os.environ.get("OWNER", "Anime_Library_N4")
#OWNER ID
OWNER_ID = int(os.environ.get("OWNER_ID", "5380609667"))
#Port
PORT = os.environ.get("PORT", "8030")
#Database
DB_URI = os.environ.get("DATABASE_URL", "mongodb+srv://hanemo2969:ywIjmR6hj2ntxk2A@cluster0.errugno.mongodb.net/?retryWrites=true&w=majority&appName=Cluster0")
